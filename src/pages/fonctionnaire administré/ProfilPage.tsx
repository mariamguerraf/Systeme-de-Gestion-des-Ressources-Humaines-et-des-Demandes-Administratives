        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            <div className="flex items-center space-x-3 bg-white bg-opacity-10 px-4 py-2 rounded-full backdrop-blur-sm">
              ...
              <span className="font-medium">Bienvenue, {userData?.prenom && userData?.nom ? `${userData.prenom} ${userData.nom}` : user?.prenom && user?.nom ? `${user.prenom} ${user.nom}` : 'Fonctionnaire'}</span>
            </div>
            <button
